...
object PullRequest {
  def buildFrom(json: JsValue): Option[PullRequest] = {
...
object PullRequestState {
  ...
  def getBy(owner: String, repo: String, commitSha: String) = {
...
object PullRequestConfiguration {
  def getBy(owner: String, projectName: String): Option[ApprovalsConfig] = {
